      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 items-center gap-2">
          ...
          <div className="hidden md:flex items-center space-x-8 font-semibold text-sm text-slate-600">
            ...
            <Link href="/services" className="hover:text-blue-950 transition-colors">Services</Link>
            <Link href="/about" className="hover:text-blue-950 transition-colors">About Us</Link>
            <Link href="/contact" className="hover:text-blue-950 transition-colors">Contact Us</Link>
            <Link
              href="/quote"
              className="px-4 py-2 bg-blue-900 hover:bg-blue-950 text-white font-bold rounded-xl transition-colors shadow-md shadow-blue-600/10"
            >
              Get a Quote
            </Link>
          </div>
        ...
        <div className="md:hidden" id="mobile-menu">
          <div className="px-2 pt-2 pb-4 space-y-1 sm:px-3 font-semibold text-slate-600 bg-white border-b border-slate-100 shadow-inner">
            <Link
              ...
              className="block px-3 py-2.5 rounded-xl hover:bg-slate-50 hover:text-blue-950 transition-all"
            >
              Home
            </Link>
            <Link
            ...
            <div className="pt-2 px-3">
              <Link
                href="/quote"
                onClick={() => setIsOpen(false)}
                className="block text-center py-3 bg-blue-900 hover:bg-blue-950 text-white font-bold rounded-xl transition-colors shadow-md"
              >
                Get a Quote
              </Link>
            </div>
